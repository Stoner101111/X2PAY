...
Accept USDC payments on physical hardware using x402 protocol over Bluetooth (BLE).

## 📁 Examples

- **x402_arduino_example.ino** - Basic HTTPS-based x402 implementation
- **COFFEE-MACHINE-EXAMPLE.ino** - Advanced BLE-based x402 with mobile app
- **MOBILE-APP-EXAMPLE.ts** - React Native mobile app for BLE payments
- **ADVANCED-COFFEE-README.md** - Complete coffee machine guide
